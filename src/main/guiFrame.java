...
public class guiFrame extends JFrame {
	...
	public static void populateConfigPanel() {
		...
		configPanel.add(
				toEncodeSPane = new JScrollPane(toEncodeText = new JTextArea(3, 20),
						JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER),
				new GBC(0, 1, 2, 1).setInsets(0, 0, 3, 5));
		configPanel.add(
				encodedSPane = new JScrollPane(encodedText = new JTextArea(3, 20),
						JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER),
				new GBC(2, 1, 2, 1));
	...
	public static void main(String args[]) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				...
				jframe.setIconImage(
						new ImageIcon("C:\\Users\\Nikhil Shinde\\workspace-java\\BarcodeGenerator\\res\\appIcon.jpg")
								.getImage());
			}
		});
	}
